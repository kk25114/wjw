...
INSERT INTO origin_table VALUES
    (1, '130503670401001'),  
    (2, '13050319900301001X'),-- 18位，校验位为X
    (3, '110105901231067'),   
    (4, '320311770706001'),   
    (5, '610104620411123'),   
    (6, '440102199901010034'),-- 18位，校验位为数字
    (7, '44010219820606053X'),-- 18位，校验位为X
    (8, '511027840506030'),   
    (9, '123456789012345'),   
    (10, '320311198504101234'); -- 18位示例
    ...
    SELECT
        ...
        CASE WHEN LENGTH(sfzh) = 15
             THEN CONCAT(
                   ...
                   CASE 
                     WHEN SUBSTR(sfzh, 7, 2)  BETWEEN 00 AND 04 
                          THEN '20'      -- 如果出生年份(YY)在[00,04]之间，补'20'
                     ELSE '19'          -- 否则补'19'
                   END,
